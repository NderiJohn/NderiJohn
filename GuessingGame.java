...
//import java.awt.image.*;
    ...
    public Test() {
        ...
        In.setToolTipText("Guess a number buddy!!!");
         ...
         for (int i= 0; i<3;i++) {
        	...
        	if (e.getSource()==Check) {
        		 Random generator = new Random();
        	        n = generator.nextInt(101);
        	        if (i==0) {
        	        message2.setText(message2.getText()+"You guessed " + Guess);     
        	        }
        	        if (i==1) {
            	        message3.setText(message3.getText()+"You guessed " + Guess);     
            	        }
        	        if (i==2) {
            	        message4.setText(message4.getText()+"You guessed " + Guess);     
            	        }
